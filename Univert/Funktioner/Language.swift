...
class StringManager {
    ...
    private let sv: [String: String] = [
        ...
        "unlockadvancedunits": "Lås upp avancerade enheter",
    ...
    private let en: [String: String] = [
        ...
        "unlockadvancedunits": "Unlock advanced units",
    ...
    private let de: [String: String] = [
        ...
        "unlockadvancedunits": "Erweiterte Einheiten freischalten",
    ...
    private let es: [String: String] = [
        ...
        "unlockadvancedunits": "Desbloquear unidades avanzadas",
    ...
    private let fr: [String: String] = [
        ...
        "unlockadvancedunits": "Déverrouiller les unités avancées",
