...
struct Inductance: View {
    ...
    @State private var selectedFromUnit: String? = "H"
    @State private var selectedToUnit: String? = "H"
    ...
    let unitId = "inductance"
    
    let units = ["H", "aH", "fH", "pH", "nH", "µH", "mH", "cH", "dH", "daH", "hH", "kH", "MH", "GH", "TH", "PH", "EH"]
    ...
    var body: some View {
        ...
        .padding(.top, 20)
        Spacer()
        .navigationTitle(StringManager.shared.get("unit_inductance"))
        .padding()
        .onAppear {
    ...
    func convertInductance(value: Double, fromUnit: String, toUnit: String) -> Double? {
        ...
        let valueInHenries = value * fromFactor
        return valueInHenries / toFactor
    }

    func updateOutputValue(inputDouble: Double) {
        if let result = convertInductance(value: inputDouble, fromUnit: selectedFromUnit ?? "", toUnit: selectedToUnit ?? "") {
