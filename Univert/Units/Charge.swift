...
struct Charge: View {
    ...
    let units = ["c", "aC", "fC", "pC", "nC", "µC", "mC", "kC", "MC", "Ah"]
    ...
    var body: some View {
        ...
        .padding(.top, 20)
        Spacer()
        .navigationTitle(StringManager.shared.get("unit_charge"))
        .padding()
        .onAppear {
    ...
    func convertCharge(value: Double, fromUnit: String, toUnit: String) -> Double? {
        ...
        let valueInCoulombs = value * fromFactor
        return valueInCoulombs / toFactor
    }

    func updateOutputValue(inputDouble: Double) {
        if let result = convertCharge(value: inputDouble, fromUnit: selectedFromUnit ?? "", toUnit: selectedToUnit ?? "") {
