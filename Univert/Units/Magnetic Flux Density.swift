...
struct Magnetic_Flux_Density: View {
    ...
    @State private var selectedFromUnit: String? = "T"
    @State private var selectedToUnit: String? = "T"
    ...
    let unitId = "magnetic_flux_density"
    
    let units = ["T", "mT", "µT", "nT", "pT", "fT", "aT", "G", "mG", "kG"]
    ...
    var body: some View {
        ...
        .padding(.top, 20)
        Spacer()
        .navigationTitle(StringManager.shared.get("unit_magnetic_flux_density"))
        .padding()
        .onAppear {
    ...
    func convertMagneticFluxDensity(value: Double, fromUnit: String, toUnit: String) -> Double? {
        ...
        let valueInTesla = value * fromFactor
        return valueInTesla / toFactor
    }

    func updateOutputValue(inputDouble: Double) {
        if let result = convertMagneticFluxDensity(
            value: inputDouble,
